...
Given('a login to practice site with {string} and {string}', async function (userName, password) {
...
When('uncheck terms', async function () {
    await this.page.locator("#terms").uncheck();
});

Then('check blinking of the text', async function () {
